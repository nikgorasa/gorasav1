# TC-08: International — 2 Rooms (1A+2C / 2A)
...
2. **Static Data** (if first time):
   ...
   - CityList(CountryCode=IN) → CityCode for Kuala Lumpur
   - TBOHotelCodeList(CityCode) → HotelCodes for Kuala Lumpur
3. **Search** (HotelAPI/Search):
   - HotelCodes from step 2 (comma-separated, max 100)
   - CheckIn/CheckOut: 2025-06-20/2025-06-22
   - PaxRooms: [{"adults":1,"children":2,"childrenAges":[3,6]},{"adults":2,"children":0,"childrenAges":[]}]
   - GuestNationality: IN
