# TC-07: International — 2 Rooms, 1 Adult each
...
2. **Static Data** (if first time):
   ...
   - CityList(CountryCode=IN) → CityCode for Singapore
   - TBOHotelCodeList(CityCode) → HotelCodes for Singapore
3. **Search** (HotelAPI/Search):
   - HotelCodes from step 2 (comma-separated, max 100)
   - CheckIn/CheckOut: 2025-06-20/2025-06-22
   - PaxRooms: [{"adults":1,"children":0,"childrenAges":[]},{"adults":1,"children":0,"childrenAges":[]}]
   - GuestNationality: IN
